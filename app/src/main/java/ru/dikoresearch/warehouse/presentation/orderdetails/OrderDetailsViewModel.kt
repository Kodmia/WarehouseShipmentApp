...
import ru.dikoresearch.warehouse.domain.workers.ImageUploadWorker
import ru.dikoresearch.warehouse.presentation.utils.BASE_URL_IMAGES
import ru.dikoresearch.warehouse.presentation.utils.NavigationConstants
import ru.dikoresearch.warehouse.presentation.utils.NavigationEvent
...
class OrderDetailsViewModel @Inject constructor(
    ...
    private fun startUpload(orderId: Int, workManager: WorkManager){
        ...
        //TODO add permissions request for Android 13
    ...
    fun showProductLocation(art: String){
        viewModelScope.launch(Dispatchers.IO){

            val result = warehouseRepository.showProductLocation(art)
